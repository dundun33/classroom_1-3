...
window.CLASSROOM_DATA = {
  ...
  items: [
    ...
    {id:'hg1',cat:'no',date:'2026-07-03',dateLabel:'7/3 (木)',subject:'英語',title:'文法プリントの解答を配信',
      details:['先週木曜の文法プリントの解答をClassroomに流す','各自で答え合わせして勉強に役立てる'],thread:'英語',poster:'平岡裕子',posted:'7/3',url:'https://classroom.google.com/c/ODU4NTUxNTUzOTEy/p/ODY4OTg4ODQyMjg5'},
    {id:'kg3',cat:'no',date:'2026-07-03',dateLabel:'7/3 (金)',subject:'全体',title:'軽井沢 生活係の会（清掃・食事・入浴係）',
      details:['7/3(金)の終礼・清掃後に集合','清掃係: 406(1年6組)','食事係: 405(1年5組)','入浴係: 404(1年4組)'],thread:'82回生',poster:'鈴木秀一',posted:'7/1',url:'https://classroom.google.com/c/ODU4NTUxNTUzOTEy/p/ODY4ODM4NTI4Njk4'},
