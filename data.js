...
window.CLASSROOM_DATA = {
  ...
  timetable: {
    ...
    rows: [
      [ {s:'期末テスト',t:'',r:'4日目',rs:3}, {s:'学活',t:'担任',r:'HR'},   {s:'家',t:'菊池',r:'被服B'},   {s:'数',t:'山口',r:'HR'},          {s:'英',t:'本木',r:'HR'} ],
      ...
      [ {s:'MHC学生交流会',t:'',r:'南ホール'}, {s:'体',t:'石井',r:'HR'},    {s:'軽井沢',t:'担任',r:'HR'}, {s:'軽井沢',t:'担任',r:'HR'},      {s:'軽井沢',t:'担任',r:'HR'} ],
      [ {s:'音',t:'阿佐美',r:'声楽'},        {s:'学年学活',t:'',r:'大ホール'}, {s:'ようこそ先輩',t:'担任',r:'HR'}, {s:'宿題',t:'菊池',r:'HR'},   {s:'体',t:'押切・新谷',r:'プール'} ],
      [ {s:'英・社',t:'コリンズ・馬場',r:'HR'}, {s:'自治の会',t:'',r:'HR'},  {s:'自治の会',t:'',r:'HR'},   {s:'英',t:'平岡',r:'HR'},          {s:'英',t:'平岡',r:'HR'} ],
    ]
  },
