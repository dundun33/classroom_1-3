...
window.CLASSROOM_DATA = {
  ...
  timetable: {
    ...
    rows: [
      ...
      [ {s:'音',t:'阿佐美',r:'声楽'},     {s:'学活',t:'担任',r:'HR',rs:2},     {s:'数',t:'山口',r:'HR'},         {s:'英',t:'磯崎・吉野',r:'LL/400'}, {s:'家',t:'菊池',r:'サクラボ',rs:2} ],
      [ {s:'社',t:'宮崎',r:'HR'},        null,                                {s:'音',t:'矢沢',r:'声楽器楽'},     {s:'数',t:'森本',r:'HR'},        null ],
      [ {s:'英',t:'平岡',r:'HR'},        {s:'体',t:'新谷',r:'二体'},          {s:'美',t:'芝',r:'美術室',rs:2},   {s:'理',t:'松本',r:'理科A',rs:2}, {s:'社',t:'宮崎',r:'HR'} ],
      [ {s:'数',t:'森本',r:'HR'},        {s:'自治の会',t:'',r:''},            null,                             null,                             {s:'数',t:'森本・山口',r:'HR/数メ'} ],
    ]
  },
  items: [
    /* --- 1. 宿題・提出物（締切順） --- */
