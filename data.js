...
window.CLASSROOM_DATA = {
  ...
  timetable: {
    ...
    rows: [
      [ {s:'大雨のため休校',t:'',r:'',rs:6}, {s:'英語テスト',t:'',r:'50分'},       {s:'理',t:'大越・小山',r:'理科A/B'}, {s:'国',t:'鈴木',r:'HR'},        {s:'英',t:'コリンズ・マオ',r:'LL/400'} ],
      [ null,                                {s:'漢字テスト',t:'',r:'9:55-10:25'}, {s:'英',t:'本木',r:'HR'},         {s:'体',t:'石井',r:'HR'},        {s:'国',t:'秦野',r:'HR'} ],
      [ null,                                {s:'体',t:'新谷',r:'二体'},           {s:'数',t:'山口',r:'HR'},         {s:'英',t:'磯崎・吉野',r:'LL/400'}, {s:'家',t:'菊池',r:'サクラボ',rs:2} ],
      [ null,                                {s:'音',t:'阿佐美',r:'声楽'},         {s:'音',t:'矢沢',r:'声楽器楽'},     {s:'数',t:'森本',r:'HR'},        null ],
      [ null,                                {s:'学活',t:'担任',r:'HR'},          {s:'美',t:'芝',r:'美術室',rs:2},   {s:'理',t:'松本',r:'理科A',rs:2}, {s:'社',t:'宮崎',r:'HR'} ],
      [ null,                                {s:'数学 学推',t:'',r:'50分'},        null,                             null,                             {s:'数',t:'森本・山口',r:'HR/数メ'} ],
    ]
  },
  items: [
    /* --- 1. 宿題・提出物（締切順） --- */
