...
window.CLASSROOM_DATA = {
  ...
  items: [
    ...
    {id:'mail-Q9JGoXZjuD',cat:'no',dateLabel:'当面の間',subject:'全体',title:'通学路の不審者情報について',
      details:['通学路で、始業後に単独歩行中の高校生を対象とする類似事案が発生','登下校やクラブ活動で登校する際は、できるだけ複数人で歩き、不審者を見かけた・遭遇した場合は警察官または警備員へ知らせる','学校は警察へ通報済みで、警備員とともに警戒を強化中'],
      thread:'',poster:'保護者向けメール',posted:'9/19',mail:true,mailPageUrl:'https://www.y.line-nt.com/linenet/member/jwu-j-net/Q2INSF1UQi/mail/Q9JGoXZjuD'},
