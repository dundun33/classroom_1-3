...
window.CLASSROOM_DATA = {
  ...
  items: [
    ...
    {id:'mg2',cat:'hw',date:'2026-07-03',dateLabel:'7/3 (金) まで',subject:'数学',title:'方程式プリント再提出・特別課題',
      ...
      thread:'1年 数学',poster:'山口朋子',posted:'7/2'},
    {id:'rk1',cat:'hw',date:'2026-07-03',dateLabel:'7/3 (金)',subject:'理科1分野',title:'理科1ノート回収・ロイロ提出の最終確認',
      ...
      thread:'理科1分野',poster:'松本珠希',posted:'7/2'},
    ...
    {id:'kg3',cat:'no',date:'2026-07-03',dateLabel:'7/3 (金)',subject:'全体',title:'軽井沢 生活係の会（清掃・食事・入浴係）',
      details:['7/3(金)の終礼・清掃後に集合','清掃係: 406(1年6組)','食事係: 405(1年5組)','入浴係: 404(1年4組)'],thread:'82回生',poster:'鈴木秀一',posted:'7/1'},
    {id:'mat3',cat:'no',date:'2026-07-06',dateLabel:'7/6 (月) まで',subject:'国語',title:'1学期 国語（文法）テスト範囲【資料】',
      details:['詳細はClassroomの投稿を確認'],thread:'国語',url:'https://classroom.google.com/c/ODU4NTUxNTUzOTEy/m/ODY4NTk5MDgzMTk2/details'},
    ...
    {id:'mat1',cat:'no',date:'2026-07-07',dateLabel:'7/7 (火) 〜',subject:'全体',title:'7月7日〜（資料）',
      details:['詳細はClassroomの投稿を確認'],thread:'82回生',poster:'松本珠希',posted:'7/3',url:'https://classroom.google.com/c/ODU4NTUxNTUzOTEy/m/ODY4OTkyNTU0NjI0/details'},
    ...
    {id:'cal7',cat:'no',dateLabel:'当面の間',subject:'全体',title:'7月カレンダー【資料】',
      details:['7月の予定カレンダー','詳細はClassroomの投稿を確認'],thread:'82回生',poster:'國澤恒久',posted:'6/30',url:'https://classroom.google.com/c/ODU4NTUxNTUzOTEy/m/Nzk4MzUwNTg4NDY5/details'},
